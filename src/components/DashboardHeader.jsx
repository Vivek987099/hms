...
function DashboardHeader(props) {
  return (
    <>
      <div className="w-full dark:bg-gray-800  flex justify-between items-center p-4 bg-white rounded-xl px-15 shadow-[1px_1px_3px_rgba(0,0,0,0.1),-1px_-1px_3px_rgba(0,0,0,0.1)] mb-5">
        <div>
